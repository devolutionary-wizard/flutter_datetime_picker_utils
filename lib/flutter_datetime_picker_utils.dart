library flutter_datetime_picker_utils;

import 'dart:async';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/painting.dart';
import 'package:flutter_datetime_picker_utils/src/datetime_picker_theme.dart';
import 'package:flutter_datetime_picker_utils/src/date_model.dart';
import 'package:flutter_datetime_picker_utils/src/i18n_model.dart';

export 'package:flutter_datetime_picker_utils/src/datetime_picker_theme.dart';
export 'package:flutter_datetime_picker_utils/src/date_model.dart';
export 'package:flutter_datetime_picker_utils/src/i18n_model.dart';
...
class DatePicker {
  ...
  static Future<DateTime?> showDatePicker(
    ...
    FlutterDatePickerUtilsTheme? theme,
  }) async {
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        theme = theme ?? const FlutterDatePickerUtilsTheme(),
  ...
  final FlutterDatePickerUtilsTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    FlutterDatePickerUtilsTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(FlutterDatePickerUtilsTheme theme) {
  ...
  Widget _renderItemView(FlutterDatePickerUtilsTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(FlutterDatePickerUtilsTheme theme) {
